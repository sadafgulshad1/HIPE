...
def inference(opt, emb, metric, data_loader, model, result_path, class_names, no_average,
              output_topk):
    print('inference')
    ...
    with torch.no_grad():
        for i, (inputs, targets) in enumerate(data_loader):
            ...
            apred, min_distances = model(inputs)
            
            
            outputs = -opt.eval_dist(apred, opt.emb, c)
