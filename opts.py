...
def parse_opts():
    ...
    parser.add_argument('--root_path',
                        default="/home/sadaf/Documents/Hierarchical_ProtoPNet_Github/UCF-101/3D_ResNet_Hyperbolic_Hierarchical",
                        type=Path,
                        help='Root directory path')
    parser.add_argument('--video_path',
                        default="/home/sadaf/Documents/Hierarchical_ProtoPNet/UCF-101-JPEG",
                        type=Path,
                        help='Directory path of videos')
    parser.add_argument('--annotation_path',
                        default="/home/sadaf/Documents/Hierarchical_ProtoPNet/UCF101TrainTestSplits-RecognitionTask/ucfTrainTestlist/ucf101_01.json",
                        type=Path,
    ...
    parser.add_argument('--emb_file',
                        default="UCF101_two_level_emb.pth",
                        type=Path,
                        help='Hyperbolic Embedding file path')
    parser.add_argument('--tree_file',
                        default="UCF-101_hierarcy.csv",
                        type=Path,
                        help='Class Hierarchy file path')
    parser.add_argument(
        '--dataset',
        default='ucf101',
        type=str,
    ...
    parser.add_argument('--pretrain_path',
                        default="r3d18_K_200ep.pth",
                        type=Path,
                        help='Pretrained model path (.pth).')
    parser.add_argument(
        '--class_specific',
        action='store_false',
        help='If true class specific training and push')
    parser.add_argument(
        '--use_l1_mask',
        action='store_true',
        help='If true masking in the loss function')
    parser.add_argument(
    ...
    parser.add_argument('--warm_learning_rate',
                        default=0.003,
                        type=float,
                        help=('Initial learning rate'
                              '(divided by 10 while training by lr scheduler)'))
    ...
    parser.add_argument('--warm_epochs',
                        default=10,
                        type=int,
                        help='Number of warm epochs to run')
    ...
    parser.add_argument('--resume_path',
                        default=None,
                        # default = "/var/scratch/sgulshad/Postdoc/Hierarchical_ProtoPNet_Video/Code_from_system/ResNet_3D_Original_Code/3D-ResNets-PyTorch_ProtoPNet_Hyper_P_C/c_p_g_no_of_prototypes_10/save_100.pth",
                        type=Path,
    ...
    parser.add_argument(
        '--dist_func',
        default=pair_wise_eud,
        help=
        'distance function'
    )
    parser.add_argument(
        '--eval_dist',
        default=pair_wise_cos,
        help=
        'evaluation function'
    )
